...
(use-package org
  ...
  (setq org-capture-templates
	`(("t" "Tasks / Projects")
	  ...
	  ("wp" "Proceedings" entry (file+olp+datetree "~/Documents/OrgFiles/Journal.org")
...
(defun org-font-setup ()
  ...
  (dolist (face '((org-level-1 . 1.2)
		  ...
		  (org-level-7 . 1.1)
		  (org-level-8 . 1.1)))
    (set-face-attribute (car face) nil :font "JetBrainsMonoNF" :weight 'regular :height (cdr face)))
